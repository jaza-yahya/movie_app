...
MoviesDiscoverModel moviesDiscoverModelFromJson(String str) =>
    MoviesDiscoverModel.fromJson(json.decode(str));

String moviesDiscoverModelToJson(MoviesDiscoverModel data) =>
...
class MoviesDiscoverModel {
  ...
  factory MoviesDiscoverModel.fromJson(Map<String, dynamic> json) =>
      MoviesDiscoverModel(
        page: json["page"],
